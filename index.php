...
<head>
  ...
  <meta name="twitter:description"
    content="Bring African art to your home, office and living. Supporting talented Rwandan artists" />
  ...
  <meta name="description"
    content="Bring African art to your home, office and living room or collect it in Kigali. We support emerging Rwandan artists and give them the recognition they deserve. ">
  <meta name="keywords"
...
<body>
    ...
    <div class="w-80 mw7 bg-white pa3 shadow-5">
      <div class="flex flex-column flex-row-ns">
        <div class="w-100 w-40-ns pa2">
          <img src="media/janvier profile pic.webp" alt="Janvier, a Rwandan artist and founder of NJ Talents"
            class="w-100 h-auto">
          <img
            src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/11/c9/20/ab/kigali-arts-center-artworks.jpg?w=500&h=400&s=1"
            alt="Janvier, a Rwandan artist and founder of NJ Talents" class="w-100 h-auto">
        ...
        <div class="w-100 w-60-ns pa3">
          ...
          <p class="f6 lh-copy tc about-text">
            <cms:editable name='p-1' label='Paragraph 1' maxlength='200' type='text' group="about-texts">
          ...
          <p class="f6 lh-copy tc about-text">
            <cms:editable name='p-2' label='Paragraph 2' maxlength='200' type='text' group="about-texts">
              Rwanda’s art scene is young and booming. Multiple art galleries and
              handmade jewellery shops were established in recent years.
    ...
    <div class="flex flex-wrap justify-center">
      <div class="w-100 w-50-m w-25-l pa2">
        <div class=" tc artwork-card shadow-5 pa2">
          <img src="<cms:editable name='elephant' label='Elephant' desc='Upload another image here' show_preview='1' group='artwork-images'
          type='image'>media/elephant.svg</cms:editable>" alt="Painting of an African elephant" class="w-100 pointer"
            onclick="openModal('media/cow painting.webp')">
      ...
      <div class="w-100 w-50-m w-25-l pa2 ">
        <div class="tc artwork-card shadow-5 pa2">
          <img src="<cms:editable name='dark_mountain' label='Dark mountain' desc='Upload another image here' show_preview='1'
          group='artwork-images' type='image'>media/dark mountain.svg</cms:editable>"
            alt="A mystical mountain at night with trees" class="w-100 pointer"
            onclick="openModal('media/fabric painting.webp')">
      ...
      <div class="w-100 w-50-m w-25-l pa2">
        <div class="tc artwork-card shadow-5 pa2">
          <img src="<cms:editable name='blue_landscape' label='Blue landscape' desc='Upload another image here' show_preview='1'
          group='artwork-images' type='image' >media/blue painting.webp</cms:editable> "
            alt="View of the lake and a mountain and a forest" class="w-100 pointer"
            onclick="openModal('media/blue painting.webp')">
      ...
      <div class="w-100 w-50-m w-25-l pa2">
        <div class="tc artwork-card shadow-5 pa2">
          <img
            src="<cms:editable name='traditional_culture' label='African traditional culture' desc='Upload another image here'
          show_preview='1' group='artwork-images' type='image'>media/african traditional culture painting.webp</cms:editable>"
            alt="Painting of tribal people in africa. Abstract" class="w-100 pointer"
            onclick="openModal('media/african traditional culture painting.webp')">
      ...
      <div class="flex flex-wrap justify-center">
        <div class="w-100 w-50-m w-25-l pa2 ">
          <div class="tc artwork-card shadow-5 pa2">
            <img src="<cms:editable name='our_tradition' label='Our tradition' desc='Upload another image here' show_preview='1'
            group='artwork-images' type='image'>media/our tradition people painting.webp</cms:editable>"
              alt="Painting of 3 africans wearing traditional clothes" class="w-100 pointer"
              onclick="openModal('media/our tradition people painting.webp')">
        ...
        <div class="w-100 w-50-m w-25-l pa2 ">
          <div class="tc artwork-card shadow-5 pa2">
            <img src="<cms:editable name='baskets_lady' label='African lady making baskets' desc='Upload another image here' show_preview='1'
            group='artwork-images' type='image'>media/african lady making baskets.svg</cms:editable>"
              alt="An African lady making baskets" class="w-100 pointer" onclick="openModal('media/necklace.webp')">
        ...
        <div class="w-100 w-50-m w-25-l pa2">
          <div class="tc artwork-card shadow-5 pa2">
            <img src="<cms:editable name='pot_lady' label='Lady with Pot' desc='Upload another image here' show_preview='1'
            group='artwork-images' type='image'>media/lady with pot painting.webp</cms:editable>"
              alt="Painting of an African lady carrying a pot on her head" class="w-100 pointer"
              onclick="openModal('media/lady with pot painting.webp')">
        ...
        <div class="w-100 w-50-m w-25-l pa2">
          <div class="tc artwork-card shadow-5 pa2">
            <img src="<cms:editable name='tradition_dancer' label='African tradition dancer' desc='Upload another image here' show_preview='1'
            group='artwork-images' type='image'>media/african tradition dancer.svg</cms:editable>"
              alt="An african traditional dancer" class="w-100 pointer"
              onclick="openModal('media/giraffe painting.webp')">
      ...
      <div class="flex flex-wrap justify-center">
        <div class="w-100 w-50-m w-25-l pa2 ">
          <div class="tc artwork-card shadow-5 pa2 waiting">
            <img src="<cms:editable name='people_painting' label='Other people painting ' desc='Upload another image here' show_preview='1'
            group='artwork-images' type='image'>media/other people painting.webp</cms:editable>"
              alt="Painting of African people dancing. Abstract" class="w-100 pointer"
              onclick="openModal('media/other people painting.webp')">
        ...
        <div class="w-100 w-50-m w-25-l pa2 waiting">
          <div class="tc artwork-card shadow-5 pa2">
            <img src="<cms:editable name='people_painting_2' label='Other people painting 2' desc='Upload another image here' show_preview='1'
            group='artwork-images' type='image'>media/other people painting 2.webp</cms:editable>" alt="Product 1"
              class="w-100 pointer" onclick="openModal('media/other people painting 2.webp')">
  ...
  <div class="flex flex-wrap justify-center">
    ...
    <a class="view-art link grow white mr2 ma2 ma-1-ns" href="#0">Email</a>
  </div>
    ...
    <div class="flex justify-center">
      <div class="w-100 mw7">
        <div class="carousel flex justify-center">
          ...
          <img src="media/other people painting 2.webp" alt="Traditional Rwandan Painting with people dancing "
            class="db w-100 w-75-ns w-50-l">
          ...
          <img src="media/other people painting.webp" alt="Traditional Rwandan Painting with people dancing"
            class="db w-100 w-75-ns w-50-l">
  ...
  <h2 class="f3 mb3 pa2 tc">
    ...
    <div class="video-container shadow-2">
      <video class="shadow-2"
        src="https://res.cloudinary.com/dpcy1ezvt/video/upload/v1693836703/testimonial_1_ydzo8p.mp4" controls></video>
  </h2>
    ...
    <div class="contact-details">
      ...
      <div class="contact-bottom">
        ...
        <div class="icon-bottom grow">
          <a href="mailto:<cms:editable name='email' label='Email' desc='Enter email to display on the page' maxlength='100' type='text'
          group='socials'>njtalentscenter@gmail.com</cms:editable>">
            <i class="fas fa-envelope" aria-label="email"></i>
          </a>
        </div>
        <!-- Whatsapp Number-->
        <div class="icon-bottom grow">
          <a href="https://wa.me/<cms:editable name='whatsapp' label='Whatsapp' desc='Enter contact to display on the page' maxlength='20' type='text'
          group='socials'>250786384028</cms:editable>">
      ...
      <p class="tc white">Website designed by <a target="_blank" class="link white underline"
          href="https://devkenya.com">DevKenya</a></p>
